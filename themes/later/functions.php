<?php
/**
 * Later functions and definitions
 *
 * @link 
 *
 * @package WordPress
...
/**
 * Later only works in WordPress 4.7 or later.
 */
...
//
//
//add_filter( 'woocommerce_single_product_flexslider_enabled', function( $size ) {
//return array(
//'width' => 300,
//'height' => 300,
//'crop' => 0,
...
function wh_insertAfterShopProductTitle()
{
    ...
    $abv = get_field('shop_page_product_name', $thePostID);
    if (empty($abv))
        return;
    echo __('<div class="product_display_store">'.$abv.'</div>', 'woocommerce');
}
