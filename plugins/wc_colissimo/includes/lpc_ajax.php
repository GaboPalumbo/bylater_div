...
class LpcAjax extends LpcComponent {
	...
	public function init() {
		...
		add_action('wp_ajax_' . LPC_COMPONENT, array($this, 'dispatch')); // Logged in users
		add_action('wp_ajax_nopriv_' . LPC_COMPONENT, array($this, 'dispatch')); // Visitors
	}
	...
	public function getUrlForTask($taskName) {
		return admin_url('admin-ajax.php?action=wc_colissimo&task=' . $taskName);
	}
}
