...
class LpcRegisterWCEmail extends LpcComponent {
	...
	public function getDependencies() {
		return array('lpcInwardLabelEmailManager', 'lpcOutwardLabelEmailManager');
	}

	public function init() {
		add_action('woocommerce_email_classes', array($this, 'generate_inward_label_woocommerce_email'));
		add_action('woocommerce_email_classes', array($this, 'generate_outward_label_woocommerce_email'));
	}
